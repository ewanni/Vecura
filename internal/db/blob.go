...
// blobToFloat32 decodes a BLOB into a []float32 without copying the underlying
// bytes (see ARCHITECTURE.md criticism #4). The returned slice shares memory
// with blob and must not be mutated.
